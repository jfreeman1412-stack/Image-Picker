...
//
// Two modes back the A–Z / Newest sort toggle on the shoot picker:
...
//              The offline cache (getShoots) preserves that same order.
//
...
// VERBATIM from the editor app (frontend/src/utils/jobSort.js) — the two
// apps share no build root, so keep the copies in lockstep so a job list
// looks identical in the editor and in capture. Tested in the editor by
// jobSort.test.mjs (node).
